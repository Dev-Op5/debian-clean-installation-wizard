...
echo "1. Nginx 1.9.x"
echo "2. PHP 5.6.x (CLI, CGI, and FPM) + PHP 7.0.x (CLI and FPM)"
echo "3. MariaDB 10.1.x + UDF"
echo "4. Git 2.x (latest)"
echo "5. NodeJS & PhantomJS"
echo "6. Composer (latest)"
echo "7. Oracle Java 8"
echo "8. AdobeAIR 2.6 (latest supported version for linux)"
echo "9. Balsamiq Mockups, SublimeText 3, and PHPStorm 10"
echo "10. Nice to have apps like Guake, Shutter, LeafPad, Google Chrome, Oracle VirtualBox, etc"
echo ""
echo ""
