...
apt install -y whois lynx openssl python perl libaio1 hdparm rsync imagemagick libmcrypt-dev \
               pcregrep gawk checkinstall cdbs devscripts dh-make libxml-parser-perl check python-pip libbz2-dev libpcre3-dev \
               libxml2-dev unixodbc-bin sysv-rc-conf uuid-dev libicu-dev libncurses5-dev libffi-dev debconf-utils \
               libjpeg-dev libgif-dev libevent-dev chrpath libfontconfig1-dev libxft-dev optipng g++ fakeroot zip p7zip-full \
