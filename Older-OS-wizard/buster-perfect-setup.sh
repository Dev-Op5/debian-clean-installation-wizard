...
apt install -y autoconf automake bash-completion bison build-essential ca-certificates cdbs \
               certbot check chrpath debconf-utils devscripts dh-make fakeroot flex fontconfig \
               g++ gawk gettext git gperf hdparm imagemagick libaio1 libasound2 libasound2-data \
               libbz2-dev libcurl4-gnutls-dev libevent-dev libexpat1-dev libffi-dev \
               libfontconfig1-dev libfreetype6 libgdbm-dev libgif-dev libicu-dev libjpeg-dev \
               libldap2-dev libmcrypt-dev libncurses5-dev libpcre3-dev libpng-dev libreadline-dev \
               libsasl2-dev libsqlite3-dev libssl-dev libtool libx11-dev libxext-dev libxft-dev \
